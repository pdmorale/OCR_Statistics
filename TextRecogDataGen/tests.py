...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), './TextRecogDataGen')))
...
from TextRecogDataGen.data_generator import FakeTextDataGenerator
from TextRecogDataGen import background_generator
from TextRecogDataGen.string_generator import (
